     ...
     <!-- <div class="pagetitle">
        ...
        <div class="maincontent">
			 ...
			 if($page):
						 ...
						 if (empty($_GET)) {
							  	 include("view/BusinessSetUp/cashbook/index.php");
							  }else{
								 $key=array_keys($_GET);
									   $SubPage=$key[0].".php";
									
									 if (file_exists("view/BusinessSetUp/cashbook/".$SubPage)) {
												
												 include("view/BusinessSetUp/cashbook/".$SubPage);
