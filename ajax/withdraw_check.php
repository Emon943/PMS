...
//die(); 
 ...
 <table width="783" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="283"><select name="payment" id="payment" required="required">
  ...
  <tr>
    ...
    <td width="283"><input type="text" name="cheque" id="cheque" required=""/></td>
  ...
  <tr>
    ...
    <td width="283"><input type="text" name="voucher_Ref" id="voucher_Ref" required /></td>
  ...
  <tr>
    ...
    <td width="283"><textarea name="des" rows="2" id="des">Fund Withdrawal By A/C: <?php echo $res[0]["dp_internal_ref_number"]; ?></textarea></td>
  ...
  <tr>
	...
	<td width="155" height="33"><strong>Withdraw Amt.:</strong></td>
     <td width="283"><input type="text" name="withdraw_amt" onkeypress="return CheckNumeric()" id="withdraw_amt" onkeyup="word.innerHTML=FormatCurrency(this.value); FormatComma(this)" required=""/></td>
