     ...
     <!-- <div class="pagetitle">
        ...
        <div class="maincontent">
			 ...
			 if($page):
						 ...
						 if (empty($_GET)) {
							  	 include("view/BusinessSetUp/house_keeping/index.php");
							  }else{
								 $key=array_keys($_GET);
									   $SubPage=$key[0].".php";
									
									 if (file_exists("view/BusinessSetUp/house_keeping/".$SubPage)) {
												
												 include("view/BusinessSetUp/house_keeping/".$SubPage);
