     ...
     <!-- <div class="pagetitle">
        ...
        <div class="maincontent">
			 ...
			 if($page):
						 ...
						 if (empty($_GET)) {
							  	 include("view/BusinessSetUp/Aprove_process/index.php");
							  }else{
								 $key=array_keys($_GET);
									   $SubPage=$key[0].".php";
									
									 if (file_exists("view/BusinessSetUp/Aprove_process/".$SubPage)) {
												
												 include("view/BusinessSetUp/Aprove_process/".$SubPage);
