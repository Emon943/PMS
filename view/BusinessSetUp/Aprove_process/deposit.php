...
<div class="row-fluid">
      ...
      <?php endif;?>
		 ...
		 $sql="SELECT * FROM `tbl_deposit_balance` where status='1' ORDER BY id DESC";
               ...
               <tr class="gradeX">
                  ...
                  <td><?php
					...
					<a href="balance_aprove.php?AccountUpdate&getID=<?php echo urlencode($enc->encryptIt($deposit_bal['id']));?>" onclick="return confirmation()" class="btn btn-danger" title="confirm Data">Aprove</a>
