...
<?php 
	...
	$id=$enc->decryptIt($_GET["getID"]);
		...
		$sql="UPDATE `tbl_deposit_balance` SET `net_balance`='$deposit_amt',`status`='2' WHERE `id`='$id'";
		...
		/*investor` Balance Update*/
         ...
         VALUES('DP','$account_dp','$type','$des','$id','NULL','$deposit_amt','$total_bal','$date','$user_id')";
         ...
         $result2=@mysql_query($sql2);
		   ...
		   echo "<h2 style='text-align:center; color:green'>Deposite Successfully Aproved</h2>";
                 ...
                 $db_obj->disconnect();
		  echo "<meta http-equiv='refresh' content='1;URL=balance_aprove.php?deposit' />";
           exit();
