          ...
          <thead>
              <tr>
                  ...
                  <th width="394" class="head0" title="Name">Bank Account Name</th>
				   <th width="394" class="head0" title="Name">Balance</th>
            ...
            <?php
              ...
              <tr class="gradeX">
                 <td><?php echo $bank_ac['account_type'];?></td>
				  ...
				  <td><?php echo number_format((float)$bank_ac['balance'], 2);?></td>
                  <td class="center"><?php echo $bank_ac['bank_name'];?></td>
                  <td class="center"><?php echo $bank_ac['branch_name'];?></td>
                  <td><?php
                    if($page['edit_status']=="Active"):
					?>
                    <a href="cashbook.php?BankAccount_Update&getID=<?php echo urlencode($enc->encryptIt($bank_ac['id']));?>" class="btn" title="Update Data"><span class=" icon-edit"></span></a>
