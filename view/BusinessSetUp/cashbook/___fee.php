     ...
     <?php
          ...
          if(@$_SESSION['in_result_data']){
            ...
            unset($_SESSION['in_result_data']);
					...
					?>
                  <div align="right"><a href="?yearly_fee" class="btn alert-info"><span class="icon-th-large"></span>Apply For All</a></div>
                     <?php endif;?>
...
.hidden-submit {
  ...
  <div class="hidden-submit"><input type="submit" name="submit_ins" tabindex="-1" /></div>
   </table>
   </form> 
	<br/>
