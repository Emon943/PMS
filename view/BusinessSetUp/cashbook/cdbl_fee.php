     ...
     <?php
          ...
          if(@$_SESSION['in_result_data']){
            ...
            unset($_SESSION['in_result_data']);
					...
					?>
                  <div align="right"><a href="?investor_info_list" class="btn alert-info"><span class="icon-th-large"></span>Investor List</a></div>
                     <?php endif;?>
  ...
  <tr>
	...
	<?php
	$sql="SELECT * FROM `transaction_type` WHERE charge_type='cdbl' AND status='Active' ORDER BY id DESC";
					 $db_obj->sql($sql);
