 ...
 <p><strong>Opening Balance : </strong><?php echo number_format((float)$balance, 2); ?></p>
...
<div class="table-wrapper-scroll-y my-custom-scrollbar">
  <table class="table table-bordered table-striped mb-0">
	...
	?>
      <tr>
	  <td><input type="checkbox" name="check[ ]"  multiple="multiple" value="<?php echo $res['deposit_amt'].";".$res['id'].";".$res['code'].";".$res['com_bank_ac'];?>" ></td>
  ...
  <button style="padding-left:10px" type="submit" class="btn btn-default" onclick="return confirmation()">Reconciliation</button>
