              ...
              <tr class="gradeX">
                <td><?php echo $instrument['short_name'];?></td>
                  ...
                  <td><?php
                    ...
                    <a href="house_keeping.php?Instrument_update&getID=<?php echo urlencode($enc->encryptIt($instrument['instrument_id']));?>" class="btn" title="Update Data"><span class=" icon-edit"></span></a>
