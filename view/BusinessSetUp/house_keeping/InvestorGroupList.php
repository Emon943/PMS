      ...
      <?php endif;?>
          ...
          <thead>
              <tr>
				  ...
				  <th width="180" class="head1" title="ISIN">IPO Charge Rate %</th>
                  <th width="180" class="head1" title="ISIN">Description</th>
                  <th width="167" class="head1" title="Industry">margin Ratio</th>
				  <th width="167" class="head1" title="Industry">Interest Rate</th>
          ...
          <tbody>
            ...
            <?php
			 ...
			 foreach($investor_group as $inv_group):
				...
				<td><?php echo $inv_group['ipo_charge'];?></td>
				...
				<td><?php echo @mysql_result(mysql_query("SELECT `interest_rate` FROM `loan_catagory_margin` WHERE `id`='".$inv_group['loan_cat']."'"),0);?></td>
                  ...
                  <td><?php
					...
					?>
                    <a href="house_keeping.php?investor_group_update&getID=<?php echo urlencode($enc->encryptIt($inv_group['investor_group_id']));?>" class="btn" title="Update Data"><span class=" icon-edit"></span></a>
