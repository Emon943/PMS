...
if(isset($_GET["getID"])){
	$broker_id=$enc->decryptIt($_GET["getID"]);
				...
				$db_obj->sql("SELECT * FROM tbl_interest_on_credit_bal WHERE id='".$db_obj->EString($broker_id)."'");
...
<div class="row-fluid" id="mydiv">
     ...
     <?php
				...
				if(isset($_POST["updateInv"])){
					...
					$acmf_interest_amt=$_POST["acmf_interest_amt"];
					
			    echo $sql1="UPDATE `tbl_interest_on_credit_bal` SET `daily_interest`='$daily_interest',`acmf_interest_amt`='$acmf_interest_amt' WHERE `id`='$id'";
				//die();
        ...
        <form action="" method="post" enctype="multipart/form-data">
		 ...
		 <tr>
           <td width="145" height="33"><strong>CMF</strong></td>
           <td width="283"><input type="text" name="acmf_interest_amt" id="acmf_interest_amt" value="<?php echo $brokerHouse[0]['acmf_interest_amt']?>" required /></td>
         </tr>
		 <tr>
