<br>
<div>
    <form action="house_stock_balance_instrument_wise.php" target="_blank" method="post" enctype="multipart/form-data" >
   Period:   <label for="pwd">From:</label>
    <input type="date" id="cdate" name="cdate" value="<?php echo date("Y-m-d"); ?>" required="required">
