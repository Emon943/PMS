...
<div class="row-fluid">
      ...
      <?php endif;?>
         ...
         <h2 style="text-align:center">Transfer of Securities(PayOut) Transfer DP Reports</h2></br>             
          ...
          <thead>
              <tr>
				  ...
				  <th width="102" class="head0">Buy Date</th>
				   <th width="102" class="head0">Code </th>
				    <th width="102" class="head0">Name </th>
                  <th width="126" class="head1">BO ID</th>
				   <th width="102" class="head0">Instrument</th>
          ...
          <tbody>
                   ...
                   <?php
					...
					$sql="SELECT * FROM tbl_payout";
					
					
					 $db_obj->sql($sql);
					 $payout_r=$db_obj->getResult();
					  //print_r($payout_r);
					 //die();
					if($payout_r){
						
						foreach($payout_r as $payout):
						
					?>  
              <tr class="gradeX">
                 <td><?php echo $payout['sl_no'];?></td>
                 <td><?php echo $payout['buy_date'];?></td>
				 <td><?php echo $payout['code'];?></td>
				 <td><?php echo $payout['name'];?></td>
				 <td><?php echo $payout['bo_id'];?></td>
				 <td><?php echo $payout['ISIN_name'];?></td>
				 <td><?php echo $payout['quantity'];?></td>
