...
<div class="row-fluid">
      ...
      <?php endif;?>
         ...
         <h2 style="text-align:center">Aging Report</h2></br>             
       	<table class="table table-bordered" id="dyntable">
                   
          <thead>
              <tr>

               	  <th width="102" class="head0">DRN</th>
				  <th width="102" class="head0">DRF</th>
				    ...
				    <th width="102" class="head0">ISIN Short Name</th>
					 <th width="102" class="head0">BO ID</th>
					  <th width="102" class="head0">BO Short Name</th>
					   <th width="102" class="head0">Requested Qty</th>
					    <th width="102" class="head0">Balance Type</th>
						 <th width="102" class="head0">Setup Date</th>
						  <th width="102" class="head0">Aging Days</th>
          ...
          <tbody>
                   ...
                   <?php
					...
					$sql="SELECT * FROM tbl_aging_report";
			  ...
			  foreach($aging as $ag):
					?>  
              <tr class="gradeX">
                 <td><?php echo $ag['DRN'];?></td>
                 <td><?php echo $ag['DRF'];?></td>
				 <td><?php echo $ag['ISIN'];?></td>
				 <td><?php echo $ag['ISIN_Short_Name'];?></td>
				 <td><?php echo $ag['BO_ID'];?></td>
				 <td><?php echo $ag['BO_Short_Name'];?></td>
				 <td><?php echo $ag['Requested_Qty'];?></td>
				 <td><?php echo $ag['Balance_Type'];?></td>
				 <td><?php echo $ag['Setup_Date'];?></td>
				 <td><?php echo $ag['Aging_Days'];?></td>
