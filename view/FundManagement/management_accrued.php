 ...
 foreach ($_POST['check'] as $id){
  ...
  $sql="SELECT ac_no,date,code,type,SUM(daily_interest)as total_interest_amt,description,status FROM `tbl_interest` where code='mf' AND ac_no='$id' AND `date` BETWEEN '$fromdate' AND '$todate' GROUP BY ac_no";
  ...
  //print_r($res);
	...
	echo "<h2 align='center' style='color:#000000'>Management Fee Successfully Deduct</h2>";
