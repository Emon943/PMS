...
<?php 
	...
	$id=$enc->decryptIt($_GET["getID"]);
		...
		$sql="UPDATE `tbl_withdraw_balance` SET `withdraw_net_balance`='$withdraw_amt',`status`='1' WHERE `id`='$id'";
		...
		/*Company Acount Balance Update*/
         ...
         VALUES('WD','$account_dp','$type','Fund withdraw','NULL','NULL','$withdraw_amt','$total_ac_bal','$date','$user_id')";
