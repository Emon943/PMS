...
if($as_on){
  ...
  $sql="SELECT * FROM `market_price_dse` WHERE date_pricedate = '$as_on' ORDER BY instrument_id ASC";
...
<br>
	...
	<h5 style="float:right;font-size: 12px; font-weight:bold;">Closing Price</h5>
	</div>
	...
	<p style="font-size: 12px; font-weight:bold;">Trade Date: <?php echo $as_on; ?></p>
  ...
  <table id="example" class="stripe row-border order-column" style="width:100%"> 
    ...
    <tr>
	  ...
	  <th>Close Market Rate</th>
	  <th>High Market Rate</th>
	  <th>Low Market Rate</th>
    ...
    <tbody>
	 ...
	 ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $r['ins_cat_id'];?></td>
                                        <td><?php echo $r['instrument_id'];?></td>
										<td><?php echo $r['isin'];?></td>
										<td><?php echo number_format((float)$r['open'],2);?></td>
										<td><?php echo number_format((float)$r['close'], 2);?></td>
										<td><?php echo number_format((float)$r['high'], 2);?></td>
										<td><?php echo number_format((float)$r['low'], 2);?></td>
...
var title = 'CAPM Advisory Limited' + '\n' + 'Tower Hamlet(9th floor),' + '\n' + '16 Kamal Ataturk Avenue,Banani C/A'+ '\n' +'Dhaka-1213,Bangladesh.'+ '\n\n' + 'Closing Price' + '\n' +'-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------';
    ...
    $('#example').DataTable( {
        ...
        buttons: [
            ...
            { extend: 'excelHtml5', footer: true, title: title, filename: 'Closing Price',  messageTop: "<?php echo "Trade Date: ".$as_on."            "."Report Date: ".date("d-M-Y")?>" },
            { extend: 'pdfHtml5', footer: true, title: title, filename: 'Closing Price',
           orientation: 'portrait',
			pageSize: 'A4',
			messageTop:'Trade Date :  <?php echo  $as_on;?>',
