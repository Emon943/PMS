		...
		?>
                                    ...
                                    <tr>
									 ...
									 ?>
										...
										<td><?php echo number_format((int)$r['qty']);?></td>
										<td><?php echo $r['rate'];?></td>
										<td><?php echo number_format((float)$r['total_amt'], 2);?></td>
										<td><?php echo number_format((float)$r['commi'], 2);?></td>
                
										<td>
										<?php if($r['type']=='Buy' || $r['type']=='Payment'){
										   echo number_format((float)$r['total_amt'], 2);
										   $sum=$sum-$r['total_amt'];
										}else{
										 echo "0.00";	
										}
			...
			<td></td>
			<td></td>
			<td><?php echo number_format((float)$dr, 2); ?></td>
			<td><?php echo number_format((float)$cr, 2); ?></td>
            <td><?php echo number_format((float)$sum, 2); ?></td>
...
var title = 'CAPM Advisory Limited' + '\n' + 'Tower Hamlet(9th floor),' + '\n' + '16 Kamal Ataturk Avenue,Banani C/A'+ '\n' +'Dhaka-1213,Bangladesh.'+ '\n\n' + 'Client Ledger Statement' + '\n' +'----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------';
    ...
    $('#example').DataTable( {
        ...
        buttons: [
            ...
            { extend: 'pdfHtml5', footer: true, title: title, filename: 'Client Ledger Statement',
           orientation: 'portrait',
			pageSize: 'A4',
			messageTop:'Client Code :  <?php echo  $ac_no ?>                                                                                                                                                         Period :  <?php echo $fromdate. '  TO  ' .$todate; ?>\n\n Client Code :  <?php echo $investor_name;?>                                                                                                                                    Balance Forward :  <?php echo $bf;?>',
