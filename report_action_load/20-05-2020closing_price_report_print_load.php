...
if($as_on){
  ...
  $sql="SELECT * FROM `market_price_dse` WHERE date_pricedate = '$as_on' ORDER BY `market_price_dse`.`instrument_id` ASC ";
    ...
    <tbody>
	 ...
	 ?>
                                    ...
                                    <tr>
                                        ...
                                        <th  scope="row"><?php echo $r['ins_cat_id'];?></th>
										<td></td>
...
var title = 'CAPM Advisory Limited' + '\n' + 'Tower Hamlet(9th floor),' + '\n' + '16 Kamal Ataturk Avenue,Banani C/A'+ '\n' +'Dhaka-1213,Bangladesh.'+ '\n' + 'Closing Price';
    ...
    $('#example').DataTable( {
        ...
        buttons: [
            ...
            { extend: 'pdfHtml5', footer: true, title: title, filename: 'Closing Price',  messageTop: "<?php echo "Trade Date: ".$as_on."            "."Report Date: ".date("d-M-Y"); ?>",
