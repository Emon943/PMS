		...
		?>
                                    ...
                                    <tr>
									 ...
									 ?>
										...
										<td>
										<?php if($r['type']=='Buy' || $r['type']=='Payment' || $r['type']=='-'){
										   echo $r['total_amt'];
										   $sum=$sum-$r['total_amt'];
										}else{
										 echo "0.00";	
			...
			<td></td>
			<td></td>
			<td><span style="font-weight:bold"><?php echo number_format((float)$dr, 2); ?></span></td>
			<td><span style="font-weight:bold"><?php echo number_format((float)$cr, 2); ?></span></td>
			<td></td>
            <td><span style="font-weight:bold"><?php echo number_format((float)$sum, 2); ?></span></td>
			<td></td>
            </tr>
        </tfoot>
...
var title = 'CAPM Advisory Limited' + '\n' + 'Tower Hamlet(9th floor),' + '\n' + '16 Kamal Ataturk Avenue,Banani C/A'+ '\n' +'Dhaka-1213,Bangladesh.'+ '\n' + 'Daily cash management fee report';
    ...
    $('#example').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            { extend: 'print', footer: true, title: title, filename: 'Daily cash management fee',  messageTop: "<?php echo"From Date: ".$fromdate."          "."TO Date: ".$todate."          "."A/C NO: ".$ac_no."      "."Report Date: ".date("d-M-Y")."      "."Balance Forward : ".$bf; ?>" },
            { extend: 'excelHtml5', footer: true, title: title, filename: 'Daily cash management fee',  messageTop: "<?php echo"To Date: ".$fromdate."          "."TO Date: ".$todate."          "."A/C NO: ".$ac_no."      "."Report Date: ".date("d-M-Y")."      "."Balance Forward : ".$bf; ?>" },
            { extend: 'pdfHtml5', footer: true, title: title, filename: 'Daily cash management fee',  messageTop: "<?php echo"From Date: ".$fromdate."          "."TO Date: ".$todate."          "."A/C NO: ".$ac_no."      "."Report Date: ".date("d-M-Y")."      "."Balance Forward : ".$bf; ?>",
