...
<table>
  <tr>
    ...
    <td width="283"><?php echo $r['receivable']; ?></td>
 ...
 <table>
  ...
  <tr>
    <td width="145" height="33"><strong>Our Referece:</strong></td>
    <td width="283">Auto Number<input type="hidden" name="our_ref" id="our_ref" value="<?php echo "BI-REC".rand(1000,9999999999); ?>"required=""/></td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td><strong>Description:</strong></td>
    <td><textarea rows="40" cols="50" type="text" name="des" id="des" required="">Bank Interest Receipt</textarea></td>
  </tr>
